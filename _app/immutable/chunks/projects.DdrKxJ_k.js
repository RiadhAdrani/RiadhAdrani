import{A as e}from"./assets.MxuRcM4c.js";import{a as t}from"./skills.Byb1cpQq.js";const n=`# Annotator
...
type DestinationRequest =
	...
	| RelativeDestinationRequest;
\`\`\`
`,A=`# JSON Parser · [![Unit Tests](https://github.com/RiadhAdrani/json-parser/actions/workflows/tests.yml/badge.svg)](https://github.com/RiadhAdrani/json-parser/actions/workflows/tests.yml)
...
`,_=[{slug:"json-parser",color:"#aaaaaa",name:"JSON Parser",logo:e.C,description:A,shortDescription:"⚡ A blazingly fast JSON parser using the blazingly fast c language",period:{from:new Date(2025,0,4),to:new Date(2025,1,4)},links:[{label:"GitHub",to:"https://github.com/RiadhAdrani/json-parser"}],skills:t("c"),type:"Library"},{slug:"slick-portfolio-svelte-5",color:"#ff3e00",name:"Portfolio Svelte 5",logo:e.Svelte,description:"The update version of my personal website portfolio using svelte 5 and shadcn-svelte",shortDescription:"The update version of my personal website portfolio using svelte 5 and shadcn-svelte",period:{from:new Date(2024,10,19)},links:[{label:"GitHub",to:"https://github.com/RiadhAdrani/slick-portfolio-svelte-5"},{label:"Demo",to:"https://riadhadrani.github.io/slick-portfolio-svelte-5/"}],skills:t("ts","svelte","sass","vite","unocss","css","node","vite","tailwind"),type:"Website"},{slug:"qanat",color:"white",name:"Qanat",logo:e.Deno,description:"A simple backend framework for the deno runtime. Work in progress !",shortDescription:"A simple backend framework for the deno runtime. Work in progress !",period:{from:new Date(2024,9,15)},links:[{label:"GitHub",to:"https://github.com/RiadhAdrani/qanat"}],skills:t("ts","deno"),type:"Backend Framework"},{slug:"dom-router",color:"green",description:D,shortDescription:"Router for the dom",links:[{to:"https://github.com/RiadhAdrani/dom-router",label:"GitHub"}],logo:e.NodeJs,name:"Dom Router",period:{from:new Date(2023,11,3),to:new Date(2024,1,4)},skills:t("ts","node","vitest","vite"),type:"Library"},{slug:"domer",color:"green",description:R,shortDescription:"A library to build DOM faster",links:[{to:"https://github.com/RiadhAdrani/domer",label:"GitHub"}],logo:e.NodeJs,name:"Domer",period:{from:new Date(2023,11,14),to:new Date(2024,0,28)},skills:t("ts","node","vitest","vite"),type:"Library"},{slug:"annotator",color:"#c82829",description:n,shortDescription:"A basic annotation tools for documents",links:[{to:"https://github.com/RiadhAdrani/annotator",label:"GitHub"}],logo:e.Unknown,name:"Annotator",period:{from:new Date(2023,10,3),to:new Date(2024,0,1)},skills:t("ts","reactjs","node","rust","mongodb","redis","vite","unocss","docker"),type:"Desktop App",screenshots:[{label:"Welcome",src:c},{label:"Sign Up",src:l},{label:"Sign In",src:r},{label:"Dashboard",src:a},{label:"Annotating",src:s},{label:"Annotation in progress",src:o},{label:"Label creation",src:i}]},{slug:"docuniser",color:"#747bff",description:d,shortDescription:"A simple desktop application that allow user to create and manage documents locally.",links:[{to:"https://github.com/RiadhAdrani/docuniser",label:"GitHub"}],logo:e.Unknown,name:"Docuniser",period:{from:new Date(2023,8,23),to:new Date(2023,9,1)},skills:t("ts","reactjs","node","vite","electron","unocss","docker"),type:"Desktop App",screenshots:[{label:"Home page",src:y},{label:"About modal",src:p},{label:"Docs grid display",src:f},{label:"Docs compact grid display",src:w},{label:"Docs list display",src:v},{label:"Docs sorting options",src:k},{label:"Document creation",src:u},{label:"Document page",src:b},{label:"Document check list",src:m},{label:"Document sub docs",src:g},{label:"Dark Mode",src:h}]},{slug:"govid",color:"#007d9c",description:"A youtube clone with Golang as backend.",shortDescription:"A youtube clone with Golang as backend.",links:[{to:"https://github.com/RiadhAdrani/govid",label:"GitHub"}],logo:e.Go,name:"GoVid",period:{from:new Date(2023,5,24),to:new Date(2023,8,14)},skills:t("ts","node","vite","go","docker","redis","unocss"),type:"Web App"},{slug:"postcss-ignore-file-plugin",color:"#c82829",description:"PostCSS plugin that ignore a file with a comment.",shortDescription:"PostCSS plugin that ignore a file with a comment.",links:[{to:"https://github.com/RiadhAdrani/postcss-plugin-ignore-file",label:"GitHub"}],logo:e.Postcss,name:"Ignore file plugin",period:{from:new Date(2023,7,16),to:new Date(2023,7,16)},skills:t("js","postcss","node","jest"),type:"Plugin"},{slug:"ruvy",color:"#ffffff",description:"React from scratch, but better",shortDescription:"React from scratch, but better",links:[{to:"https://github.com/RiadhAdrani/ruvy",label:"GitHub"},{to:"https://riadhadrani.github.io/ruvy/",label:"Documentation"},{to:"https://github.com/RiadhAdrani/create-ruvy",label:"CLI"},{to:"https://www.npmjs.com/package/@riadh-adrani/ruvy",label:"NPM"},{to:"https://stackblitz.com/edit/ruvy?file=package.json,src%2Fmain.tsx",label:"Stackblitz"}],logo:e.Ruvy,name:"Ruvy",period:{from:new Date(2023,2,1),to:new Date(2024,7,15)},skills:t("ts","node","vite","vitest","unocss"),type:"Web Framework"},{slug:"dom-utils",color:"#5cad47",name:"Dom Utils",logo:e.NodeJs,description:"Create and manipulate DOM elements.",shortDescription:"Create and manipulate DOM elements.",period:{from:new Date(2022,9,28),to:new Date(2024,7,15)},links:[{label:"GitHub",to:"https://github.com/RiadhAdrani/dom-control-js"},{label:"NPM",to:"https://www.npmjs.com/package/@riadh-adrani/dom-control-js"},{label:"Docs",to:"https://riadhadrani.github.io/dom-control-js/"}],skills:t("ts","node","vite","vitest"),type:"JavaScript library"},{slug:"werewolves-dart",color:"#fbb03b",name:"Werewolves",logo:e.Werewolves,description:"An app to manage your game of Loup garous de thiercelieu also known as The Werewolves of Millers Hollow.",shortDescription:"An app to manage your game of Loup garous de thiercelieu also known as The Werewolves of Millers Hollow.",period:{from:new Date(2022,6,23),to:new Date(2023,7,23)},links:[{label:"GitHub",to:"https://github.com/RiadhAdrani/werewolves"}],skills:t("dart","flutter"),type:"Mobile App"},{slug:"portfolio",color:"#ff3e00",name:"Portfolio",logo:e.Svelte,description:"My personal website portfolio.",shortDescription:"My personal website portfolio.",period:{from:new Date(2023,1,24)},links:[{label:"GitHub",to:"https://github.com/RiadhAdrani/RiadhAdrani"}],skills:t("ts","svelte","sass","vite","unocss"),type:"Website"},{slug:"recursive",color:"#cf2026",name:"Recursive",logo:e.Unknown,description:"Recursive is an ongoing project that allow developers to build a functional, component-based, Javascript only, beautiful and interactive Web applications.",shortDescription:"Recursive is an ongoing project that allow developers to build a functional, component-based, Javascript only, beautiful and interactive Web applications.",period:{from:new Date(2021,8,1),to:new Date(2022,11,26)},links:[{label:"GitHub",to:"https://github.com/RiadhAdrani/recursive"},{label:"NPM",to:"https://www.npmjs.com/package/@riadh-adrani/recursive"}],skills:t("js","node","jest"),type:"UI Framework"},{slug:"utils",color:"#5cad47",name:"Utils",logo:e.NodeJs,description:"My JavaScript utility functions and types.",shortDescription:"My JavaScript utility functions and types.",period:{from:new Date(2022,8,1),to:new Date(2023,9,10)},links:[{label:"GitHub",to:"https://github.com/RiadhAdrani/utility-js"},{label:"NPM",to:"https://www.npmjs.com/package/@riadh-adrani/utility-js"}],skills:t("ts","node","vite","vitest"),type:"JavaScript library"},{slug:"solid-github",color:"#518ac8",name:"Solid GitHub",logo:e.SolidJs,description:"Web app that retrieves repositories from GitHub and displaying them with the ability to be saved and persisted in the local storage.",shortDescription:"Web app that retrieves repositories from GitHub and displaying them with the ability to be saved and persisted in the local storage.",period:{from:new Date(2022,10,1),to:new Date(2022,10,10)},links:[{label:"GitHub",to:"https://github.com/RiadhAdrani/solid-github"}],skills:t("solid","ts","node"),type:"Web App"},{slug:"gradio",name:"Gradio",type:"Web App",logo:e.Unknown,color:"#52bffa",period:{from:new Date(2022,9,1),to:new Date(2022,9,10)},links:[{label:"GitHub",to:"https://github.com/RiadhAdrani/gradio"}],description:"A web application used to create and generate gradient background for css usage.",shortDescription:"A web application used to create and generate gradient background for css usage.",skills:t("quasar","node","js")},{slug:"random-name-picker",name:"Random Name Picker",type:"Android App",logo:e.Unknown,color:"#64c6c5",period:{from:new Date(2022,7,1),to:new Date(2022,7,10)},links:[{label:"GitHub",to:"https://github.com/RiadhAdrani/random-name-picker"}],description:"An android application used to create lists for random name picking. Lists and user preferences are saved",shortDescription:"An android application used to create lists for random name picking. Lists and user preferences are saved",skills:t("kotlin")},{slug:"question-submission",name:"Question Submission",type:"Web App",logo:e.Unknown,color:"#ffde16",period:{from:new Date(2021,6,1),to:new Date(2021,7,10)},links:[{label:"GitHub",to:"https://github.com/RiadhAdrani/guess-app-questions-submission"}],description:"A website that allow users to submit their questions and answers for a possible game app.",shortDescription:"A website that allow users to submit their questions and answers for a possible game app.",skills:t("node","vue","js","firebase")},{slug:"azur-app",name:"Azur City",type:"Android App",logo:e.Azur,color:"#01acc8",period:{from:new Date(2021,1,1),to:new Date(2021,4,10)},links:[{label:"GitHub",to:"https://github.com/RiadhAdrani/azur_app"}],description:"A prototype of a commercial app made for Azur City. The App was presented as an End of studies projects.",shortDescription:"A prototype of a commercial app made for Azur City. The App was presented as an End of studies projects.",skills:t("kotlin")},{slug:"werewolves-kt",name:"Werewolves",type:"Android App",logo:e.Werewolves,color:"#fbb03b",period:{from:new Date(2021,0,1),to:new Date(2021,5,10)},links:[{label:"GitHub",to:"https://github.com/RiadhAdrani/werewolves_of_the_millers_hollow"}],description:'Creating a guide for the game "Werewolves of The Millers Hollow" originally "Les loups garous de Thierclieux".',shortDescription:'Creating a guide for the game "Werewolves of The Millers Hollow" originally "Les loups garous de Thierclieux".',skills:t("kotlin")},{slug:"color-noter",name:"Color Noter",type:"Cross platform App",logo:e.Unknown,color:"#8cacb9",period:{from:new Date(2020,8,1),to:new Date(2020,9,10)},links:[{label:"GitHub (Android)",to:"https://github.com/RiadhAdrani/color_note_plus"},{label:"GitHub (Desktop)",to:"https://github.com/RiadhAdrani/color_noter-desktop"},{label:"GitHub (Web)",to:"https://github.com/RiadhAdrani/color_noter-web"}],description:"Color Noter is a color based note taking app that offer the user the ability to write and save his ideas and todos in an easy to use environment.",shortDescription:"Color Noter is a color based note taking app that offer the user the ability to write and save his ideas and todos in an easy to use environment.",skills:t("java","electron","reactjs","firebase")}],T="Projects",L={title:T,items:_};export{L as P};
