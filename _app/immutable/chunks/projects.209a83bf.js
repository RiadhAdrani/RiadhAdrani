import{A as t}from"./UIcon.d19ab0ad.js";import{g as e}from"./skills.14c5fa3f.js";const n=`# Annotator
...
`,o=""+new URL("../assets/annotating-in-progress.c7184ae3.png",import.meta.url).href,s=""+new URL("../assets/annotating.b636a71c.png",import.meta.url).href,a=""+new URL("../assets/dashboard.a64e542b.png",import.meta.url).href,i=""+new URL("../assets/label-creation.e6ef7447.png",import.meta.url).href,r=""+new URL("../assets/sign-in.1c4b9d49.png",import.meta.url).href,l=""+new URL("../assets/sign-up.f21a5a9e.png",import.meta.url).href,c=""+new URL("../assets/welcome.d23e8a42.png",import.meta.url).href,d=`# Docuniser
...
type DestinationRequest =
	...
	| RelativeDestinationRequest;
\`\`\`
`,T=[{slug:"dom-router",color:"green",description:D,shortDescription:"Router for the dom",links:[{to:"https://github.com/RiadhAdrani/dom-router",label:"GitHub"}],logo:t.NodeJs,name:"Dom Router",period:{from:new Date(2023,11,3),to:new Date(2024,1,4)},skills:e("ts","node","vitest","vite"),type:"Library"},{slug:"domer",color:"green",description:R,shortDescription:"A library to build DOM faster",links:[{to:"https://github.com/RiadhAdrani/domer",label:"GitHub"}],logo:t.NodeJs,name:"Domer",period:{from:new Date(2023,11,14),to:new Date(2024,0,28)},skills:e("ts","node","vitest","vite"),type:"Library"},{slug:"annotator",color:"#c82829",description:n,shortDescription:"A basic annotation tools for documents",links:[{to:"https://github.com/RiadhAdrani/annotator",label:"GitHub"}],logo:t.Unknown,name:"Annotator",period:{from:new Date(2023,10,3),to:new Date(2024,0,1)},skills:e("ts","reactjs","node","rust","mongodb","redis","vite","unocss","docker"),type:"Desktop App",screenshots:[{label:"Welcome",src:c},{label:"Sign Up",src:l},{label:"Sign In",src:r},{label:"Dashboard",src:a},{label:"Annotating",src:s},{label:"Annotation in progress",src:o},{label:"Label creation",src:i}]},{slug:"docuniser",color:"#747bff",description:d,shortDescription:"A simple desktop application that allow user to create and manage documents locally.",links:[{to:"https://github.com/RiadhAdrani/docuniser",label:"GitHub"}],logo:t.Unknown,name:"Docuniser",period:{from:new Date(2023,8,23),to:new Date(2023,10,0)},skills:e("ts","reactjs","node","vite","electron","unocss","docker"),type:"Desktop App",screenshots:[{label:"Home page",src:k},{label:"About modal",src:p},{label:"Docs grid display",src:f},{label:"Docs compact grid display",src:w},{label:"Docs list display",src:v},{label:"Docs sorting options",src:y},{label:"Document creation",src:u},{label:"Document page",src:b},{label:"Document check list",src:h},{label:"Document sub docs",src:g},{label:"Dark Mode",src:m}]},{slug:"govid",color:"#007d9c",description:"A youtube clone with Golang as backend.",shortDescription:"A youtube clone with Golang as backend.",links:[{to:"https://github.com/RiadhAdrani/govid",label:"GitHub"}],logo:t.Go,name:"GoVid",period:{from:new Date(2023,5,24),to:new Date(2023,8,14)},skills:e("ts","node","vite","go","docker","redis","unocss"),type:"Web App"},{slug:"postcss-ignore-file-plugin",color:"#c82829",description:"PostCSS plugin that ignore a file with a comment.",shortDescription:"PostCSS plugin that ignore a file with a comment.",links:[{to:"https://github.com/RiadhAdrani/postcss-plugin-ignore-file",label:"GitHub"}],logo:t.Postcss,name:"Ignore file plugin",period:{from:new Date(2023,7,16),to:new Date(2023,7,16)},skills:e("js","postcss","node","jest"),type:"Plugin"},{slug:"ruvy",color:"#ffffff",description:"React from scratch, but better",shortDescription:"React from scratch, but better",links:[{to:"https://github.com/RiadhAdrani/ruvy",label:"GitHub"},{to:"https://riadhadrani.github.io/ruvy/",label:"Documentation"},{to:"https://github.com/RiadhAdrani/create-ruvy",label:"CLI"},{to:"https://www.npmjs.com/package/@riadh-adrani/ruvy",label:"NPM"},{to:"https://stackblitz.com/edit/ruvy?file=package.json,src%2Fmain.tsx",label:"Stackblitz"}],logo:t.Ruvy,name:"Ruvy",period:{from:new Date(2023,2,1)},skills:e("ts","node","vite","vitest","unocss"),type:"Web Framework"},{slug:"dom-utils",color:"#5cad47",name:"Dom Utils",logo:t.NodeJs,description:"Create and manipulate DOM elements.",shortDescription:"Create and manipulate DOM elements.",period:{from:new Date(2022,9,28)},links:[{label:"GitHub",to:"https://github.com/RiadhAdrani/dom-control-js"},{label:"NPM",to:"https://www.npmjs.com/package/@riadh-adrani/dom-control-js"},{label:"Docs",to:"https://riadhadrani.github.io/dom-control-js/"}],skills:e("ts","node","vite","vitest"),type:"JavaScript library"},{slug:"werewolves-dart",color:"#fbb03b",name:"Werewolves",logo:t.Werewolves,description:"An app to manage your game of Loup garous de thiercelieu also known as The Werewolves of Millers Hollow.",shortDescription:"An app to manage your game of Loup garous de thiercelieu also known as The Werewolves of Millers Hollow.",period:{from:new Date(2022,6,23)},links:[{label:"GitHub",to:"https://github.com/RiadhAdrani/werewolves"}],skills:e("dart","flutter"),type:"Mobile App"},{slug:"portfolio",color:"#ff3e00",name:"Portfolio",logo:t.Svelte,description:"My personal website portfolio.",shortDescription:"My personal website portfolio.",period:{from:new Date(2021,3,1)},links:[{label:"GitHub",to:"https://github.com/RiadhAdrani/RiadhAdrani"}],skills:e("ts","svelte","sass","vite","unocss"),type:"Website"},{slug:"recursive",color:"#cf2026",name:"Recursive",logo:"https://raw.githubusercontent.com/RiadhAdrani/recursive/master/logo.png",description:"Recursive is an ongoing project that allow developers to build a functional, component-based, Javascript only, beautiful and interactive Web applications.",shortDescription:"Recursive is an ongoing project that allow developers to build a functional, component-based, Javascript only, beautiful and interactive Web applications.",period:{from:new Date(2021,8,1),to:new Date(2022,11,26)},links:[{label:"GitHub",to:"https://github.com/RiadhAdrani/recursive"},{label:"NPM",to:"https://www.npmjs.com/package/@riadh-adrani/recursive"}],skills:e("js","node","jest"),type:"UI Framework"},{slug:"utils",color:"#5cad47",name:"Utils",logo:t.NodeJs,description:"My JavaScript utility functions and types.",shortDescription:"My JavaScript utility functions and types.",period:{from:new Date(2022,8,1)},links:[{label:"GitHub",to:"https://github.com/RiadhAdrani/utility-js"},{label:"NPM",to:"https://www.npmjs.com/package/@riadh-adrani/utility-js"}],skills:e("ts","node","vite","vitest"),type:"JavaScript library"},{slug:"solid-github",color:"#518ac8",name:"Solid GitHub",logo:t.SolidJs,description:"Web app that retrieves repositories from GitHub and displaying them with the ability to be saved and persisted in the local storage.",shortDescription:"Web app that retrieves repositories from GitHub and displaying them with the ability to be saved and persisted in the local storage.",period:{from:new Date(2022,10,1),to:new Date(2022,10,10)},links:[{label:"GitHub",to:"https://github.com/RiadhAdrani/solid-github"}],skills:e("solid","ts","node"),type:"Web App"},{slug:"gradio",name:"Gradio",type:"Web App",logo:t.Unknown,color:"#52bffa",period:{from:new Date(2022,9,1),to:new Date(2022,9,10)},links:[{label:"GitHub",to:"https://github.com/RiadhAdrani/gradio"}],description:"A web application used to create and generate gradient background for css usage.",shortDescription:"A web application used to create and generate gradient background for css usage.",skills:e("quasar","node","js")},{slug:"random-name-picker",name:"Random Name Picker",type:"Android App",logo:t.Unknown,color:"#64c6c5",period:{from:new Date(2022,7,1),to:new Date(2022,7,10)},links:[{label:"GitHub",to:"https://github.com/RiadhAdrani/random-name-picker"}],description:"An android application used to create lists for random name picking. Lists and user preferences are saved",shortDescription:"An android application used to create lists for random name picking. Lists and user preferences are saved",skills:e("kotlin")},{slug:"question-submission",name:"Question Submission",type:"Web App",logo:t.Unknown,color:"#ffde16",period:{from:new Date(2021,6,1),to:new Date(2021,7,10)},links:[{label:"GitHub",to:"https://github.com/RiadhAdrani/guess-app-questions-submission"}],description:"A website that allow users to submit their questions and answers for a possible game app.",shortDescription:"A website that allow users to submit their questions and answers for a possible game app.",skills:e("node","vue","js","firebase")},{slug:"azur-app",name:"Azur City",type:"Android App",logo:t.Azur,color:"#01acc8",period:{from:new Date(2021,1,1),to:new Date(2021,4,10)},links:[{label:"GitHub",to:"https://github.com/RiadhAdrani/azur_app"}],description:"A prototype of a commercial app made for Azur City. The App was presented as an End of studies projects.",shortDescription:"A prototype of a commercial app made for Azur City. The App was presented as an End of studies projects.",skills:e("kotlin")},{slug:"werewolves-kt",name:"Werewolves",type:"Android App",logo:t.Werewolves,color:"#fbb03b",period:{from:new Date(2021,0,1),to:new Date(2021,5,10)},links:[{label:"GitHub",to:"https://github.com/RiadhAdrani/werewolves_of_the_millers_hollow"}],description:'Creating a guide for the game "Werewolves of The Millers Hollow" originally "Les loups garous de Thierclieux".',shortDescription:'Creating a guide for the game "Werewolves of The Millers Hollow" originally "Les loups garous de Thierclieux".',skills:e("kotlin")},{slug:"color-noter",name:"Color Noter",type:"Cross platform App",logo:t.Unknown,color:"#8cacb9",period:{from:new Date(2020,8,1),to:new Date(2020,9,10)},links:[{label:"GitHub (Android)",to:"https://github.com/RiadhAdrani/color_note_plus"},{label:"GitHub (Desktop)",to:"https://github.com/RiadhAdrani/color_noter-desktop"},{label:"GitHub (Web)",to:"https://github.com/RiadhAdrani/color_noter-web"}],description:"Color Noter is a color based note taking app that offer the user the ability to write and save his ideas and todos in an easy to use environment.",shortDescription:"Color Noter is a color based note taking app that offer the user the ability to write and save his ideas and todos in an easy to use environment.",skills:e("java","electron","reactjs","firebase")}],C="Projects";export{T as i,C as t};
